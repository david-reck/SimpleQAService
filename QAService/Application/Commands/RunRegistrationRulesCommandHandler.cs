...
{
    public class RunRegistrationRulesCommandHandler : IRequestHandler<RunRegistrationRulesCommand, bool>
    {
        ...
        public async Task<bool> Handle(RunRegistrationRulesCommand message, CancellationToken cancellationToken)
        {
